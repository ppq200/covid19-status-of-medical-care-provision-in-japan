    ...
    df = (
        ...
        .rename(
            columns={
                ...
                "Unnamed: 7": "確保_病床使用率_重症者",
                "Unnamed: 8": "確保_病床使用率_重症者_前週差",
                "Unnamed: 9": "確保想定_病床使用率_重症者",
                "Unnamed: 10": "確保想定_病床使用率_重症者_前週差",
                # 単位: 対人口10万人
                "Unnamed: 11": "療養者数",
                "Unnamed: 12": "療養者数_前週差",
                "Unnamed: 13": "調整列",
                ...
                # 監視体制
                #
                "Unnamed: 14": "陽性者数/PCR検査件数",
                "Unnamed: 15": "陽性者数/PCR検査件数_前週差",
                "Unnamed: 16": "調整列_2",
                #
                # 感染の状況
                #
                "Unnamed: 17": "陽性者数",
                "Unnamed: 18": "陽性者数_前週差",
                "Unnamed: 19": "直近1週間とその前週比",
                "Unnamed: 20": "直近1週間とその前週比_前週差",
